  ...
  return (
    ...
    <Nav className='justify-content-center' tabs>
        <NavItem>
            <NavLink active>
                <ChevronDown size={20} />
                <span className='align-middle' style={{fontSize:"20px"}}>Members</span>
            </NavLink>
        </NavItem>
    </Nav>
            ...
            <div className="sec-2E mx-auto mt-3 justify-content-center">
                <div className="sec-2C">
                    ...
                    <div className="sec-2CP">
                        Lead <ChevronDown size={15} color="#ffffff"/><br/>
                        <strong> Shilei Lin </strong> <br/><br/>
                        Website <ChevronDown size={15} color="#ffffff"/><br/>
                        <strong> Ahmed Abbas </strong> <br/>
                        <strong> Jessica Li </strong> <br/><br/>
                        UI/UX <ChevronDown size={15} color="#ffffff"/><br/>
                        <strong> Miraal Kabir </strong> <br/><br/>
                        Intern <ChevronDown size={15} color="#ffffff"/><br/>
                ...
                <div className="sec-2C">
                    ...
                    <div className="sec-2CP">
                        Project <ChevronDown size={15} color="#ffffff"/><br/>
                        <strong> Ryan Xu </strong> <br/><br/>
                        Business <ChevronDown size={15} color="#ffffff"/><br/>
                ...
                <div className="sec-2C">
                    ...
                    <div className="sec-2CP">
                        Development <ChevronDown size={15} color="#ffffff"/><br/>
                        <strong> Abdul Takiddeen </strong> <br/>
                        <strong> Manoosh Samiei </strong> <br/><br/>
                        Research <ChevronDown size={15} color="#ffffff"/><br/>
