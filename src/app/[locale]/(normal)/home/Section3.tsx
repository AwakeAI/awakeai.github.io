...
import Bg from "@/images/drag-effect/bg.png";
import Fa from "@/images/drag-effect/fa.png";
import Mo from "@/images/drag-effect/mod.png";
import Mo2 from "@/images/drag-effect/mod2.png";
import fHome from "@/images/drag-effect/home.png";
import Nw from "@/images/drag-effect/nw.png";
import Effect from "@/images/drag-effect/effect.png";
import NwEffect from "@/images/drag-effect/nweffect.png";
    ...
    <Center w="100%" pt="60px" pb="80px" bg={{ base: color, lg: color }}>
      <Flex w="100%" direction="column" px="30px" maxW="1440px">
        ...
        <Heading
          ...
          textAlign="left"
        >
          {t.rich("Our Advanced AI Technology", {
            label: (v) => (
