                        ...
                        <Col lg="3" md="6" sm="6" key={i}>
                            <div className="team-item mb-50 wow fadeInUp">
                                ...
                                <div className="team-info text-center">
                                    <h4 style={{color: "#ebe9f1"}}>{item.firstName} {item.lastName}</h4>
                                    <span className="position">{item.position}</span>
                                </div>
                            </div>
                            <Modal isOpen={modalId === item.id} toggle={handleCloseModal} size="md">
                                ...
                                <ModalBody>
                                    <div className="container">
                                        <Row className=" justify-content-center">
                                            <Col sm="10" className="ins-image align-items-center">
                                                <img src={item.image} alt={item.firstName}/>
                                            </Col>
                                        </Row>
                                        <Row className="justify-content-center">
                                            <Col sm="10" style={{maxWidth: "320px"}}>
