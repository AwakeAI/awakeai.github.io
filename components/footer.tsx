...
const Footer = () => {
  return (
    <footer className="dark:bg-neutral-700 bg-neutral-50 border-t dark:border-neutral-400 border-neutral-200">
      <Container>
        <div className="mt-16 mb-16 grid md:grid-flow-col md:gap-x-8 lg:gap-x-8 sm:content-center justify-center mr-2">
          ...
          <div className="md:col-span-3 md:w-full h-full mx-auto justify-center">
            ...
            <Separator.Root
              className="bg-gray-400 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px my-[15px]"/>
